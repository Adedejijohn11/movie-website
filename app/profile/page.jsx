      ...
      <div className=" h-[50%] w-[70%] flex flex-col">
        ...
        <div className="h-full w-full grid grid-cols-2 lg:grid-cols-4  gap-2 mt-6">
          <div className=" h-auto w-auto  flex flex-col items-center">
            <div className="relative h-[180px] w-[180px] rounded-full bg-sky-400 ">
              <div className="absolute right-7 lg:right-0 bottom-0 h-10 w-10 flex items-center justify-center text-black text-[12px] bg-white rounded-full">
                <ImPencil />
              </div>
            </div>
          ...
          <div className=" h-auto w-auto   flex flex-col items-center">
            <div className=" relative h-[180px] w-[180px] rounded-full bg-amber-700 ">
              <div className="absolute right-7 lg:right-0 bottom-0 h-10 w-10 flex items-center justify-center text-black text-[12px] bg-white rounded-full">
                <ImPencil />
              </div>
            </div>
          ...
          <div className=" h-auto w-auto flex flex-col items-center">
            <div className=" relative h-[180px] w-[180px] rounded-full bg-pink-200 ">
              <div className="absolute right-7 lg:right-0 bottom-0 h-10 w-10 flex items-center justify-center text-black text-[12px] bg-white rounded-full">
                <ImPencil />
              </div>
            </div>
